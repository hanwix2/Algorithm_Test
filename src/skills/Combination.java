...
public class Combination {
    ...
    public static void main(String[] args) {
        ...
        // Combination02 - 재귀
        comb.combination02(arr, visit, 0, 0, len, 2);
    }
    ...
    // <재귀를 이용한 조합>
    public void combination02(int[] arr, boolean[] visit, int idx, int cnt, int n, int r) {
        if (cnt == r) {
            print(arr, visit, n);
            return;
        }
        ...
        visit[idx] = true;
        combination02(arr, visit, idx + 1, cnt + 1, n, r);
        visit[idx] = false;
        combination02(arr, visit, idx + 1, cnt, n, r);
